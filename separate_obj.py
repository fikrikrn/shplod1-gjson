...
def split_obj_by_shapefile(obj_file, shapefile_path, output_folder, tolerance):
    """
    ...
    # Iterate over features in the shapefile with a progress bar
    with tqdm(total=len(sf.shapeRecords()), desc="Processing shapes", unit="feature") as pbar:
